...
class PlaybackMotionGenerator
{
    public:
        ...
        )
        {
            ...
            Eigen::VectorXd::Map(&q_command[0], 7) = p.x;
    ...
    private:
        ...
        double                          m_time = 0;
        SequentialQuinticInterpolator   m_interpolator;
        std::vector<Eigen::VectorXd>    m_joint_positions;
        std::vector<Eigen::VectorXd>    m_joint_velocities;
        std::vector<Eigen::VectorXd>    m_joint_accelerations;
};
